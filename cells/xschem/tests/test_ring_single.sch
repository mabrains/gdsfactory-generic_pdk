...
model=ring_single
spiceprefix=P}
C {../symbols/ring_single.sym} 100 -275 1 0 {name=ring2
gap=0.2
radius=10.0
length_x=4.0
length_y=0.6
model=ring_single
spiceprefix=P}
C {../symbols/ring_single.sym} 920 540 0 0 {name=ring3
gap=0.2
radius=10.0
length_x=4.0
length_y=0.6
model=ring_single
spiceprefix=P}
C {../symbols/ring_single.sym} 1255 -275 1 0 {name=ring4
gap=0.2
radius=10.0
length_x=4.0
length_y=0.6
model=ring_single
spiceprefix=P}
C {../symbols/ring_single.sym} 2160 -120 0 0 {name=ring5
ggap=0.2
radius=10.0
length_x=4.0
length_y=0.6
